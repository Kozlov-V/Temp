...
create(Conn) ->
    ...
    obj:async_call(Pid, set_pos, [#vec{x=X, y=10, z=Z}]),
    obj:async_call(Pid, quadtree_assign),
    obj:async_call(Pid, query_env),
    %obj:async_call(Pid, enable_logging),
    obj:async_call(Pid, set_heart_beat, [1000]),
    %obj:async_call(Pid, set_speed, [10]),
